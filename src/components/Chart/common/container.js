...
class SVGContainer extends React.Component {
    ...
    render() {
        ...
        return (
            <div className='ssd-chart-wrapper' ref={ref => this.ref = ref} style={{ display: 'inline-block', position: 'relative' }} onMouseOverCapture={this.onMouseOver} onMouseLeave={this.onMouseMove}>
                    ...
                    <g transform={`translate(${paddingLeft},${paddingTop})`}>
                        {
                            elements.map(component => 
                                    React.cloneElement(component, { width, height })
                            )
                        }
                        {
 ...
 */
const computeBoundingClientRect = (Component) => {
...
export const Container = computeBoundingClientRect(SVGContainer)
